...
vlog $VLOG_FLAGS +acc=rn +incdir+ ${TOP_DIR}includes/riscv_pkg.sv ${TOP_DIR}includes/drac_pkg.sv ${TOP_DIR}rtl/datapath/rtl/exe_stage/rtl/alu.sv tb_module.sv colors.vh
