...
#(
  parameter type                     TagType     = logic
   ...
   // TODO For widening conversions add invalid flag checking.
   ...
   assign result_d    = (is_move_i == 1'b1) ? result_move : result_conv;
   assign status_d    = (is_move_i == 1'b1) ? status_move : status_conv;
   assign tag_d       = tag_i;
