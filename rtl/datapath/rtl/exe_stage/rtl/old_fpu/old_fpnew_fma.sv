...
module old_fpnew_fma #(
  ...
  localparam int unsigned BIAS     = old_fpnew_pkg::bias(FpFormat);
  ...
  localparam int unsigned EXP_WIDTH = unsigned'(old_fpnew_pkg::maximum(EXP_BITS + 2, LZC_RESULT_WIDTH));
  ...
  // Input processing
  // -----------------
  old_fpnew_pkg::fp_info_t [2:0] info_q;
