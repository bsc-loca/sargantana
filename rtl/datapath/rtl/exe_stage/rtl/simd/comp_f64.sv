...
// comp_f64.sv
// IEEE-754 2008 double-precision combinational comparator
...
// separate fields
logic sa, sb;           // signs
logic [10:0] ea, eb;    // exponents
logic [51:0] ma, mb;    // mantissas

assign {sa, ea, ma} = srca_i;
assign {sb, eb, mb} = srcb_i;

assign is_nan_o = is_nan_f64(srca_i)  || is_nan_f64(srcb_i);
assign invalid  = is_snan_f64(srca_i) || is_snan_f64(srcb_i);
