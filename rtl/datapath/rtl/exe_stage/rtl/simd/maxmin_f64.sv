...
// maxmin_f64.sv
// SystemVerilog unit for FP64 MAXMIN operation
...
module maxmin_f64 (
    ...
    input  logic [63:0] srca_i,     // source operand A 
    input  logic [63:0] srcb_i,     // source operand B
    output logic [63:0] ret_o,      // result
...
always_comb begin
    ...
    if ( is_nan_f64(srca_i) && is_nan_f64(srcb_i) ) begin
        ret_o = FP64_QNAN;
    // if only one operand is NAN always return the other operand
    end else if (is_nan_f64(srca_i)) begin
        ret_o = srcb_i;        
    end else if (is_nan_f64(srcb_i)) begin
        ret_o = srca_i;
